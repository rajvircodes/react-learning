                ...
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <NavLink to="/github" className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-500"} `}>
                                        Github
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/discord" className={({ isActive }) => `${isActive ? "text-orange-700" : "text-gray-500"}`}>
                                        Discord
                                    </NavLink>
                                </li>
                            </ul>
